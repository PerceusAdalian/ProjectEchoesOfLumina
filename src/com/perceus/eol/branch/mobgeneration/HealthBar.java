...
public class HealthBar
{
	...
	{
		String bossBarTitle = PrintUtils.ColorParser("&f" + entity.getCustomName() + 
				" &6AP&f: &7(&f" + ArbitraryHealthContainer.getArmor(entity) + "&7/&f" + 
				ArbitraryHealthContainer.getBaseMaxArmor(entity) + "&7)");
